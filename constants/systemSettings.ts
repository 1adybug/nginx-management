...
export const SystemSettingGroups: SystemSettingGroupDefinition[] = [
    ...
    {
        key: SystemSettingGroupKey.Nginx,
        label: "Nginx 设置",
        description: "控制代理服务配置写入、测试、启动和停止行为。",
    },
]
...
export const SystemSettingDefinitions: SystemSettingDefinition[] = [
    ...
    {
        key: SystemSettingKey.自动应用Nginx配置,
        group: SystemSettingGroupKey.Nginx,
        kind: SystemSettingValueKind.布尔,
        label: "自动应用 Nginx 配置",
        description: "关闭后会立即停止当前 Nginx 进程，并跳过代理服务配置写入与重载。",
        defaultValue: "1",
    },
    {
        key: SystemSettingKey.Nginx命令,
        group: SystemSettingGroupKey.Nginx,
        kind: SystemSettingValueKind.文本,
        label: "Nginx 命令",
